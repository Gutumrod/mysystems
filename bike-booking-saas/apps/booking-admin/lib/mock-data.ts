...
export const demoBookings: Booking[] = [
  ...
  },
  {
    id: "demo-booking-2",
    shop_id: demoShop.id,
    customer_name: "กิตติ ช่างแต่ง",
    customer_phone: "0899991111",
    customer_fb: "Kitti Bike",
    customer_line_id: null,
    booking_date: new Date().toISOString().slice(0, 10),
    booking_end_date: null,
    booking_kind: "hourly",
    booking_time_start: "14:00",
    booking_time_end: "17:00",
    bike_model: "Yamaha NMAX",
    bike_year: 2022,
    service_items: [demoServices[2].id],
